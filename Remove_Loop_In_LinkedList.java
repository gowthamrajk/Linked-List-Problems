...
public class Remove_Loop_In_LinkedList
{
	static class Node
	{
	    int data; 
    ...
    static int detectLoop(Node head,int flag)
    {
        ...
        while(true)
        {
            ...
            if(slowPointer==fastPointer)
            {
                ...
                if(flag==1)
                {
                    ...
                    System.out.print("Loop removed successfully");
                    return 0;
                }
    ...
    public static void main(String args[]) 
    {
        ...
        int loopPos=sc.nextInt(),temp=0;
        System.out.println(loopPos+"\n");
        createLoop(head,loopPos);
        System.out.println("Loop created Successfully\n");
        if(detectLoop(head,0)==0)
        System.out.print("Loop not found");
        else
        System.out.println("Loop found at Node which has the value of "+detectLoop(head,0));
        System.out.println();
        temp=detectLoop(head,1);
        sc.close();
    }
}